...
$$\langle \partial_\mu J^{\mu5} \rangle = \mathcal M^{\mu\nu} \cdot \frac12 A_\mu(k_1) A_\nu(k_2) = \frac{-e^2}{16\pi^2} F\wedge F ~,$$ where in the last step, we went back to position space. It is now clear this is a topological term.
...
### Physical consequences (\\(\pi^0 \to \gamma\gamma\\))
